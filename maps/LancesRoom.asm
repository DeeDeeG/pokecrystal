...
LancesRoomLanceScript:
	...
	opentext
	writetext LancesRoomMaryItsAllOverText
	waitbutton
	closetext
	...
	opentext
	writetext LancesRoomMaryLetsInterviewText
	waitbutton
	closetext
	applymovement LANCESROOM_LANCE, LancesRoomMovementData_LancePositionsSelfToGuidePlayerAway
	turnobject PLAYER, UP
	opentext
	writetext LancesRoomLanceAskPlayerComeWithMeText
	waitbutton
	closetext
	...
	opentext
	writetext LancesRoomMaryWeHaventDoneInterviewText
	pause 30
	closetext
...
LancesRoomMaryLetsInterviewText:
	text "MARY: Let's inter-"
	line "view the brand new"
	cont "CHAMPION!"
	done

LancesRoomLanceAskPlayerComeWithMeText:
	text "LANCE: This is"
...
LancesRoomMaryWeHaventDoneInterviewText:
	text "MARY: Oh, wait!"
